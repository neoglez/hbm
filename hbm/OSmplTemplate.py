...
class OSmplTemplate:
    ...
    def __init__(self, vertices, faces, blend_weights, blend_shape_function,
                 k_joint_predictor, k_intree_table,
        ...
        self.pose_dependant_blend_shape_function = pose_dependant_blend_shape_function
